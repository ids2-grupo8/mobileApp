...
const s = StyleSheet.create({
  ...
  successBox: { borderWidth: 1, borderRadius: 16, padding: 18, marginBottom: 24 },
  successTitle: { fontSize: 18, fontWeight: '800', marginBottom: 8 },
  successText: { fontSize: 15, lineHeight: 22, fontWeight: '500' },
  errorBoxTitle: { fontSize: 16, fontWeight: '800', marginBottom: 6 },
  serverError: { borderWidth: 1, borderRadius: 14, padding: 14, marginBottom: 16 },
  serverErrorText: { fontSize: 14, lineHeight: 20 },
  center: { flex: 1, justifyContent: 'center', paddingHorizontal: 28 },
  back: { marginTop: 20, alignItems: 'center' },
  backText: { fontSize: 14, fontWeight: '600' },
  input: { borderWidth: 1, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 14, fontSize: 16, marginBottom: 4 },
});
