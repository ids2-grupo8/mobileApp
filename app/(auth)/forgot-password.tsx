    ...
    <View style={[s.root, { paddingTop: insets.top, backgroundColor: C.bg }]}>
      <KeyboardAvoidingView
        ...
        <View style={[s.content, { paddingBottom: insets.bottom + 32 }]}>
          ...
          {sent ? (
            <View style={[s.successBox, { backgroundColor: C.accentBg, borderColor: 'rgba(24,172,180,0.3)' }]}> 
              ...
              <View style={s.field}>
                ...
                <TextInput
                  style={[
                    ...
                    touched && emailError ? { borderColor: C.inputBorderError } : null,
                  ]}
                  value={email}
                ...
                />
                {touched && emailError
                  ? <Text style={[s.errorText, { color: C.red }]}>{emailError}</Text>
                  : null}
              </View>
